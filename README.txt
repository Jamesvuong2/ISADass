...
## Description
    This program asks the user for either a colour a frequency or a wavelength and outputs the associated colour, wavelength or frequency.
...
1. Clone the repository:
    ...
    git clone https://github.com/Jamesvuong2/ISADass.git
